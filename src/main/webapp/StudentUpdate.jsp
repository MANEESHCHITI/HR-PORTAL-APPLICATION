...
<body>
	...
	<%
	List<StudentModal> studentobj = (List<StudentModal>) session.getAttribute("studentlistid");
	%>
	<%
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-8 top">
				...
				<%
				for (StudentModal fm : studentobj) {
				%>

				<h4 style="text-align:center;color:green">FACULTY REGISTRATION</h4>
				<form class="form-group" method="post"
					action="studentupdate2controller" name="faculty"
					...
					<div class="row">
						...
						<div class="col-sm-6">
							<input class="form-control" type="text" id="gmail" name="mail"
								placeholder="*MAIL ID" value=<%=fm.getGmail()%>>
							<p></p>
						</div>
					</div>
					<div class="row">
						<div class="col-sm-6">
							<input class="form-control" type="text" id="year" name="year"
								placeholder="*YEARS OF PASS" value=<%=fm.getYear()%>>
						</div>
						<div class="col-sm-6">
